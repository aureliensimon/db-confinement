    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div  class="ajout_param" >
        <form action="../verif/verifparam-2.php"  enctype="multipart/form-data" method="POST">
            ...
            <div class="menu-field">
            <span class="field-name">Date min:</span>
            <br>
            <input type="date" class="field-input" name="min">
            </div>
            <div class="menu-field">
            <span class="field-name">Date max:</span>
            <br>
            <input  type="date" class="field-input" name="max">
            </div>
            <div class="menu-field">
